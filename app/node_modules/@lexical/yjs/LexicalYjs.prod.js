...
function I(a,b,c,d){d=null===d?b instanceof v.Map?Array.from(b.keys()):Object.keys(b.getAttributes()):Array.from(d);let e;for(let h=0;h<d.length;h++){let g=d[h];if(K(g,c,a))continue;var f=c[g];let l=b instanceof v.Map?b.get(g):b.getAttribute(g);if(f!==l){if(l instanceof v.Doc){let p=a.docMap;f instanceof v.Doc&&p.delete(f.guid);f=n.createEditor();let t=l.guid;f._key=t;p.set(t,l);l=f}void 0===e&&(e=c.getWritable());e[g]=l}}}
function H(a,b,c,d){var e=d.__type,f=a.nodeProperties;let h=f.get(e);void 0===h&&(h=Object.keys(d).filter(l=>!K(l,d,a)),f.set(e,h));e=a.editor.constructor;for(f=0;f<h.length;f++){let l=h[f];var g=null===c?void 0:c[l];let p=d[l];if(g!==p){if(p instanceof e){let t=a.docMap,m;g instanceof e&&(g=g._key,m=t.get(g),t.delete(g));g=m||new v.Doc;let k=g.guid;p._key=k;t.set(k,g);p=g;a.editor.update(()=>{d.markDirty()})}b instanceof v.Map?b.set(l,p):b.setAttribute(l,p)}}}
function R(a,b,c){let d=0,e=0,f=a._children,h=f.length;for(;e<h;e++){a=f[e];let g=d,l=a.getSize();d+=l;if((c?d>=b:d>b)&&a instanceof G)return c=b-g-1,0>c&&(c=0),{length:d-b,node:a,nodeIndex:e,offset:c};if(d>b)return{length:0,node:a,nodeIndex:e,offset:g};if(e===h-1)return{length:0,node:null,nodeIndex:e+1,offset:g+1}}return{length:0,node:null,nodeIndex:0,offset:0}}
...
b){let c=this.getNode();null===c&&A(91);I(a,this._xmlText,c,b)}applyChildrenYjsDelta(a,b){let c=this._children,d=0;for(let t=0;t<b.length;t++){var e=b[t],f=e.insert,h=e.delete;if(null!=e.retain)d+=e.retain;else if("number"===typeof h)for(f=h;0<f;){let {node:m,nodeIndex:k,offset:q,length:u}=R(this,d,!1);if(m instanceof Q||m instanceof E||m instanceof V)c.splice(k,1),--f;else if(m instanceof G){e=Math.min(f,u);h=0!==k?c[k-1]:null;var g=m.getSize();if(0===q&&1===e&&0<k&&h instanceof G&&u===g&&0===Array.from(m._map.keys()).length)h._text+=
m._text,c.splice(k,1);else if(0===q&&e===g)c.splice(k,1);else{h=m;g=m._text;var l=q,p=e;g=g.slice(0,l)+""+g.slice(l+p);h._text=g}f-=e}else break}else if(null!=f)if("string"===typeof f){let {node:m,offset:k}=R(this,d,!0);m instanceof G?(e=m,h=m._text,g=k,l=f,h=h.slice(0,g)+l+h.slice(g+0),e._text=h):this._xmlText.delete(k,f.length);d+=f.length}else e=f,{nodeIndex:f}=R(this,d,!1),e=P(a,e,this),c.splice(f,0,e),d+=1;else throw Error("Unexpected delta format");}}syncChildrenFromYjs(a){var b=this.getNode();
null===b&&A(92);var c=b.__key;let d=x.$createChildrenArray(b,null),e=d.length;var f=this._children;let h=f.length,g=a.collabNodeMap,l=new Set,p;let t=0;var m=null;h!==e&&b.getWritable();for(let y=0;y<h;y++){var k=d[t],q=f[y];var u=q.getNode();var r=q._key;if(null!==u&&k===r)m=n.$isTextNode(u),l.add(k),m&&(q._key=k,q instanceof Q?(m=q._xmlText,q.syncPropertiesFromYjs(a,null),q.applyChildrenYjsDelta(a,m.toDelta()),q.syncChildrenFromYjs(a)):q instanceof G?q.syncPropertiesAndTextFromYjs(a,null):q instanceof
V?q.syncPropertiesFromYjs(a,null):q instanceof E||A(93)),m=u,t++;else{if(void 0===p)for(p=new Set,r=0;r<h;r++){var w=f[r]._key;""!==w&&p.add(w)}if(null!==u&&void 0!==k&&!p.has(k)){q=L(k);T(q);y--;t++;continue}u=b.getWritable();k=a;r=q;w=c;var B=r.getType();let D=k.editor._nodes.get(B);void 0===D&&A(88,B);B=new D.klass;B.__parent=w;r._key=B.__key;r instanceof Q?(w=r._xmlText,r.syncPropertiesFromYjs(k,null),r.applyChildrenYjsDelta(k,w.toDelta()),r.syncChildrenFromYjs(k)):r instanceof G?r.syncPropertiesAndTextFromYjs(k,
null):r instanceof V&&r.syncPropertiesFromYjs(k,null);k.collabNodeMap.set(B.__key,r);k=B;r=k.__key;g.set(r,q);null===m?(m=u.getFirstChild(),u.__first=r,null!==m&&(m=m.getWritable(),m.__prev=r,k.__next=m.__key)):(q=m.getWritable(),w=m.getNextSibling(),q.__next=r,k.__prev=m.__key,null!==w&&(m=w.getWritable(),m.__prev=r,k.__next=m.__key));y===h-1&&(u.__last=r);u.__size++;m=k}}for(b=0;b<e;b++)f=d[b],l.has(f)||(c=L(f),f=a.collabNodeMap.get(f),void 0!==f&&f.destroy(a),T(c))}syncPropertiesFromLexical(a,
...
null);let g=h.length-1,l=f.length-1,p=a.collabNodeMap,t,m,k=0;for(b=0;k<=g&&b<=l;){var q=h[k];let r=f[b];if(q===r)this._syncChildFromLexical(a,b,r,c,d,e),k++,b++;else{void 0===t&&(t=new Set(h));void 0===m&&(m=new Set(f));var u=m.has(q);q=t.has(r);u?(u=L(r),u=M(a,u,this),p.set(r,u),q?(this.splice(a,b,1,u),k++):this.splice(a,b,0,u),b++):(this.splice(a,b,1),k++)}}c=k>g;d=b>l;if(c&&!d)for(;b<=l;++b)c=f[b],d=L(c),d=M(a,d,this),this.append(d),p.set(c,d);else if(d&&!c)for(f=this._children.length-1;f>=b;f--)this.splice(a,
...
function oa(a,b){var c=Array.from(b.awareness.getStates()),d=a.clientID;b=a.cursors;var e=a.editor._editorState._nodeMap;let f=new Set;for(var h=0;h<c.length;h++){let [D,qa]=c[h];if(D!==d){f.add(D);let {anchorPos:da,focusPos:ea,name:ra,color:sa,focusing:ta}=qa;var g=null,l=b.get(D);void 0===l&&(l={color:sa,name:ra,selection:null},b.set(D,l));if(null!==da&&null!==ea&&ta){var p=v.createAbsolutePositionFromRelativePosition(da,a.doc),t=v.createAbsolutePositionFromRelativePosition(ea,a.doc);if(null!==
p&&null!==t){let [fa,ha]=Z(p.type,p.index),[ia,ja]=Z(t.type,t.index);if(null!==fa&&null!==ia){p=fa.getKey();var m=ia.getKey();g=l.selection;if(null===g){g=l;t=ha;var k=ja,q=g.color,u=document.createElement("span");u.style.cssText=`position:absolute;top:0;bottom:0;right:-1px;width:1px;background-color:${q};z-index:10;`;var r=document.createElement("span");r.textContent=g.name;r.style.cssText=`position:absolute;left:-2px;top:-16px;background-color:${q};color:#fff;line-height:12px;font-size:12px;padding:2px;font-family:Arial;font-weight:bold;white-space:nowrap;`;
u.appendChild(r);g={anchor:{key:p,offset:t},caret:u,color:q,focus:{key:m,offset:k},name:r,selections:[]}}else t=g.anchor,k=g.focus,t.key=p,t.offset=ha,k.key=m,k.offset=ja}}}a:if(p=a,t=l,u=g,q=e,k=p.editor,g=k.getRootElement(),l=p.cursorsContainer,null!==l&&null!==g&&(g=l.offsetParent,null!==g))if(g=g.getBoundingClientRect(),m=t.selection,null===u)null!==m&&(t.selection=null,Y(p,m));else{t.selection=u;t=u.caret;m=u.color;p=u.selections;r=u.anchor;u=u.focus;var w=r.key,B=u.key,y=q.get(w);q=q.get(B);
if(null!=y&&null!=q){if(y===q&&n.$isLineBreakNode(y))q=[k.getElementByKey(w).getBoundingClientRect()];else{q=z.createDOMRange(k,y,r.offset,q,u.offset);if(null===q)break a;q=z.createRectsFromDOMRange(k,q)}u=p.length;k=q.length;for(r=0;r<k;r++)y=q[r],w=p[r],void 0===w&&(w=document.createElement("span"),p[r]=w,B=document.createElement("span"),w.appendChild(B),l.appendChild(w)),y=`position:absolute;top:${y.top-g.top}px;left:${y.left-g.left}px;height:${y.height}px;width:${y.width}px;pointer-events:none;z-index:5;`,
w.style.cssText=y,w.firstChild.style.cssText=`${y}left:0;top:0;background-color:${m};opacity:0.3;`,r===k-1&&t.parentNode!==w&&w.appendChild(t);for(g=u-1;g>=k;g--)l.removeChild(p[g]),p.pop()}}}}c=Array.from(b.keys());for(d=0;d<c.length;d++)e=c[d],f.has(e)||(h=b.get(e),void 0!==h&&(h=h.selection,null!==h&&Y(a,h),b.delete(e)))}
function pa(a,b,c,d){b=b.awareness;let e=b.getLocalState();if(null!==e){var {anchorPos:f,focusPos:h,name:g,color:l,focusing:p,awarenessData:t}=e,m=null,k=null;if(null!==d&&(null===f||d.is(c))||null!==c)n.$isRangeSelection(d)&&(m=W(d.anchor,a),k=W(d.focus,a)),(X(f,m)||X(h,k))&&b.setLocalState({...e,anchorPos:m,awarenessData:t,color:l,focusPos:k,focusing:p,name:g})}}let ua=n.createCommand("CONNECTED_COMMAND"),va=n.createCommand("TOGGLE_CONNECT_COMMAND");exports.CONNECTED_COMMAND=ua;
...
exports.syncLexicalUpdateToYjs=function(a,b,c,d,e,f,h,g){la(a,()=>{d.read(()=>{if(g.has("collaboration")||g.has("historic")){if(0<h.size){var l=Array.from(h),p=a.collabNodeMap,t=[];for(let u=0;u<l.length;u++){var m=l[u],k=n.$getNodeByKey(m),q=p.get(m);if(q instanceof G)if(n.$isTextNode(k))t.push([q,k.__text]);else{k=q.getOffset();if(-1===k)continue;let r=q._parent;q._normalized=!0;r._xmlText.delete(k,1);p.delete(m);m=r._children;q=m.indexOf(q);m.splice(q,1)}}for(l=0;l<t.length;l++){let [u,r]=t[l];
u instanceof G&&"string"===typeof r&&(u._text=r)}}}else e.has("root")&&(t=c._nodeMap,l=n.$getRoot(),p=a.root,p.syncPropertiesFromLexical(a,l,t),p.syncChildrenFromLexical(a,l,t,e,f)),t=n.$getSelection(),pa(a,b,c._selection,t)})})};
exports.syncYjsChangesToLexical=function(a,b,c,d){let e=a.editor,f=e._editorState;c.forEach(h=>h.delta);e.update(()=>{for(var h=0;h<c.length;h++){var g=a,l=c[h],{target:p}=l;p=P(g,p);if(p instanceof Q&&l instanceof v.YTextEvent){let {keysChanged:t,childListChanged:m,delta:k}=l;0<t.size&&p.syncPropertiesFromYjs(g,t);m&&(p.applyChildrenYjsDelta(g,k),p.syncChildrenFromYjs(g))}else p instanceof G&&l instanceof v.YMapEvent?({keysChanged:l}=l,0<l.size&&p.syncPropertiesAndTextFromYjs(g,l)):p instanceof V&&
l instanceof v.YXmlEvent?({attributesChanged:l}=l,0<l.size&&p.syncPropertiesFromYjs(g,l)):A(82)}g=n.$getSelection();n.$isRangeSelection(g)&&(S(g)?(h=f._selection,n.$isRangeSelection(h)&&(ma(a,b),S(g)&&U(g.anchor.key,f)),pa(a,b,h,n.$getSelection())):ma(a,b))},{onUpdate:()=>{oa(a,b);e.update(()=>{0===n.$getRoot().getChildrenSize()&&n.$getRoot().append(n.$createParagraphNode())})},skipTransforms:!0,tag:d?"historic":"collaboration"})}
