...
class w extends k.DecoratorNode{static getType(){return"horizontalrule"}static clone(c){return new w(c.__key)}static importJSON(){return x()}static importDOM(){return{hr:()=>({conversion:y,priority:0})}}exportJSON(){return{type:"horizontalrule",version:1}}exportDOM(){return{element:document.createElement("hr")}}createDOM(c){let a=document.createElement("hr");h.addClassNamesToElement(a,c.theme.hr);return a}getTextContent(){return"\n"}isInline(){return!1}updateDOM(){return!1}decorate(){return r.jsx(u,
{nodeKey:this.__key})}}function y(){return{node:x()}}function x(){return k.$applyNodeReplacement(new w)}function v(c){return c instanceof w}exports.$createHorizontalRuleNode=x;exports.$isHorizontalRuleNode=v;exports.HorizontalRuleNode=w;exports.INSERT_HORIZONTAL_RULE_COMMAND=t
