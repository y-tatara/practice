...
class g extends c.ElementNode{static getType(){return"overflow"}static clone(a){return new g(a.__key)}static importJSON(){return h()}static importDOM(){return null}constructor(a){super(a);this.__type="overflow"}exportJSON(){return{...super.exportJSON(),type:"overflow"}}createDOM(a){let b=document.createElement("span");a=a.theme.characterLimit;"string"===typeof a&&(b.className=a);return b}updateDOM(){return!1}insertNewAfter(a,b=!0){return this.getParentOrThrow().insertNewAfter(a,b)}excludeFromCopy(){return!0}static transform(){return a=>
{k(a)||d(204);a.isEmpty()&&a.remove()}}}function h(){return c.$applyNodeReplacement(new g)}function k(a){return a instanceof g}exports.$createOverflowNode=h;exports.$isOverflowNode=k;exports.OverflowNode=g
